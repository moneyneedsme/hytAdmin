...
export default {
  ...
  methods: {
    ...
    Added(value) {
      if (
        ...
        if (this.showNewlyType == "xz") {
          ...
          netWork("/product/productSave", data)
            .then(res => {
          ...
          netWork("/product/productModified", data)
            .then(res => {
              if (res.data.code === 200) {
                if (res.data.result) {
                  this.categoryId = null; //清除掉 筛选id
    ...
    getPageDatas() {
      ...
      netWork("/product/findProductPage", data)
        .then(res => {
          if (res.data.code === 200) {
    ...
    getSelectData() {
      netWork("/category/findCategoryTree")
        .then(res => {
